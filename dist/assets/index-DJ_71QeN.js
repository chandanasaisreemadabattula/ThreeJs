...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(e,t,n){let r=new Float32Array(No),i=new q(0,1,0);return new aa({name:`SphericalGaussianBlur`,defines:{n:No,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(){return new aa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new aa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xo(),fragmentShader:`
	...
	`}var Zo=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Hi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=mc(i,i.VERTEX_SHADER,y),S=mc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=bc(i,x,`vertex`),n=bc(i,S,`fragment`);H(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,side:1,blending:2,transparent:!0}));uu.add(hu);var gu=new Zi(lu,128,128),_u=new sa({color:16777215,shininess:25,specular:new X(3355443)}),vu=new pi(gu,_u);uu.add(vu);var yu=new Zi(lu*1.01,64,64),bu=new sa({color:16777215,transparent:!0,opacity:.4,depthWrite:!1}),xu=new pi(yu,bu);uu.add(xu);var Su=new pi(new Zi(lu*1.08,64,64),new aa({vertexShader:`
    varying vec3 vNormal;
    void main() {
      vNormal = normalize(normalMatrix * normal);
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `,side:1,blending:2,transparent:!0}));uu.add(Su);function Cu(){let e=new Tr,t=5e3,n=new Float32Array(t*3),r=new Float32Array(t*3);for(let e=0;e<t*3;e+=3){let t=100+Math.random()*400,i=Math.random()*Math.PI*2,a=Math.acos(2*Math.random()-1);n[e]=t*Math.sin(a)*Math.cos(i),n[e+1]=t*Math.sin(a)*Math.sin(i),n[e+2]=t*Math.cos(a);let o=.5+Math.random()*.5;r[e]=o,r[e+1]=o,r[e+2]=o+Math.random()*.2}return e.setAttribute(`position`,new ur(n,3)),e.setAttribute(`color`,new ur(r,3)),new Bi(e,new Fi({size:.5,vertexColors:!0,transparent:!0,opacity:.8}))}var wu=Cu();uu.add(wu);var Tu=new qa(4210752,.5);uu.add(Tu);var Eu=new Ka(16777215,1.5);Eu.position.set(5,3,5),uu.add(Eu);var Du=new Ka(8947967,.3);Du.position.set(-5,-3,-5),uu.add(Du),fu.target.set(0,0,0),fu.update();var Ou=new fo,ku=new K;window.addEventListener(`click`,e=>{let t=document.getElementById(`searchRoot`);if(t&&t.contains(e.target))return;ku.x=e.clientX/window.innerWidth*2-1,ku.y=-(e.clientY/window.innerHeight)*2+1,Ou.setFromCamera(ku,du);let n=Ou.intersectObject(vu);if(!n.length)return;let r=n[0].point,{lat:i,lon:a}=au(r),o=ou({lat:i,lon:a,earthRadius:lu,color:65280});uu.add(o),Au(i,a)});function Au(e,t){let n=document.getElementById(`coordDisplay`);n&&(n.textContent=`${e.toFixed(4)}° ${t.toFixed(4)}°`)}var ju=null;function Mu(e){return e<.5?4*e*e*e:1-(-2*e+2)**3/2}function Nu(e,t,{distance:n=2.5,dropMarker:r=!0,locationName:i=null}={}){let a=iu(e,t,lu),o=a.clone().normalize(),s=o.clone().multiplyScalar(n),c=new q(-o.z,0,o.x).normalize();s.add(c.multiplyScalar(.3)),ju={t:0,duration:1.5,startCamPos:du.position.clone(),startTarget:fu.target.clone(),endCamPos:s,endTarget:a.clone(),after:()=>{if(r){let n=ou({lat:e,lon:t,earthRadius:lu,color:16763904,name:i});uu.add(n),i&&Pu(e,t,i)}}}}function Pu(e,t,n){let r=su(n,e,t,lu);uu.add(r)}var Fu=document.getElementById(`searchInput`),Iu=document.getElementById(`searchBtn`),Lu=document.getElementById(`searchStatus`),Ru=document.getElementById(`searchResults`);function zu(e){Lu&&(Lu.textContent=e||``)}function Bu(){Ru&&(Ru.innerHTML=``)}function Vu(e){let t=e.trim().match(/^(-?\d+(\.\d+)?)\s*[, ]\s*(-?\d+(\.\d+)?)$/);if(!t)return null;let n=Number(t[1]),r=Number(t[3]);return Number.isNaN(n)||Number.isNaN(r)||n<-90||n>90||r<-180||r>180?null:{lat:n,lon:r}}async function Hu(){let e=(Fu?.value||``).trim();if(Bu(),!e){zu(`Type a place name or: lat lon`);return}let t=Vu(e);if(t){zu(`Going to ${t.lat.toFixed(4)}, ${t.lon.toFixed(4)}...`),Nu(t.lat,t.lon,{distance:2.5,dropMarker:!0,locationName:`${t.lat.toFixed(2)}, ${t.lon.toFixed(2)}`});return}zu(`Searching...`);try{let t=new URL(`https://nominatim.openstreetmap.org/search`);t.searchParams.set(`format`,`json`),t.searchParams.set(`q`,e),t.searchParams.set(`limit`,`5`);let n=await fetch(t.toString(),{headers:{Accept:`application/json`}});if(!n.ok)throw Error(`HTTP ${n.status}`);let r=await n.json();if(!Array.isArray(r)||r.length===0){zu(`No results.`);return}zu(`Found ${r.length} result(s). Click one to fly there.`);for(let e of r){let t=Number(e.lat),n=Number(e.lon),r=(e.display_name||`${t}, ${n}`).split(`,`).slice(0,2).join(`,`),i=document.createElement(`button`);i.className=`resultItem`,i.type=`button`,i.textContent=r,i.addEventListener(`click`,()=>{zu(`Going to ${t.toFixed(4)}, ${n.toFixed(4)}...`),Nu(t,n,{distance:2.5,dropMarker:!0,locationName:r})}),Ru?.appendChild(i)}}catch(e){zu(`Search failed. (${e?.message||`unknown error`})`)}}Iu?.addEventListener(`click`,Hu),Fu?.addEventListener(`keydown`,e=>{e.key===`Enter`&&Hu()});var Uu=new ho;function Wu(){if(requestAnimationFrame(Wu),Uu.getDelta(),Uu.getElapsedTime(),ju){ju.t=Math.min(1,ju.t+1/60/ju.duration);let e=Mu(ju.t);if(du.position.lerpVectors(ju.startCamPos,ju.endCamPos,e),fu.target.lerpVectors(ju.startTarget,ju.endTarget,e),fu.update(),ju.t>=1){let e=ju.after;ju=null,e?.()}}let e=new fo;e.setFromCamera(new K(0,0),du);let t=e.intersectObject(vu);if(t.length>0){let{lat:e,lon:n}=au(t[0].point);Au(e,n)}pu()}async function Gu(){let e=new Aa,t=[`/textures/earth.jpg`,`https://threejs.org/examples/textures/planets/earth_atmos_2048.jpg`],n=[`https://threejs.org/examples/textures/planets/earth_clouds_1024.png`],r=[`https://threejs.org/examples/textures/planets/earth_normal_2048.jpg`],i=[`https://threejs.org/examples/textures/planets/earth_specular_2048.jpg`];for(let n of t)try{let t=await new Promise((t,r)=>{e.load(n,t,void 0,()=>r())});t.colorSpace=Le,_u.map=t,_u.needsUpdate=!0;break}catch{console.log(`Failed to load:`,n)}for(let t of n)try{bu.map=await new Promise((n,r)=>{e.load(t,n,void 0,()=>r())}),bu.needsUpdate=!0;break}catch{console.log(`Failed to load clouds:`,t)}for(let t of r)try{_u.bumpMap=await new Promise((n,r)=>{e.load(t,n,void 0,()=>r())}),_u.bumpScale=.05,_u.needsUpdate=!0;break}catch{console.log(`Failed to load bump:`,t)}for(let t of i)try{_u.specularMap=await new Promise((n,r)=>{e.load(t,n,void 0,()=>r())}),_u.needsUpdate=!0;break}catch{console.log(`Failed to load specular:`,t)}}function Ku(){let e=document.querySelector(`.hud`);if(e){let t=document.createElement(`div`);t.id=`coordDisplay`,t.style.marginTop=`8px`,t.style.fontFamily=`monospace`,t.style.color=`#88ff88`,t.textContent=`0.0000° 0.0000°`,e.appendChild(t)}}Ku(),Wu(),Gu();